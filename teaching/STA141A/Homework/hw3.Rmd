...
Let $Z_1, Z_2, Z_3, Z_4$ be random variables each having respective pdfs $f_1, f_2, f_3, f_4$. Assume each pdf has the same variance $\sigma^2$. Also assume that the covariance between any pair of these random variables $Z_1, Z_2, Z_3, Z_4$ is $a \sigma^2$ for some $a \in [-1, 1]$. That is, assume $Cov(Z_i, Z_j) = a \sigma^2$ whenever $i \neq j$.
